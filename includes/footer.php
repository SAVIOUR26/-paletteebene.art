<footer class="site-footer" id="footer">
    <div class="footer-container">
        <div class="footer-brand">
            ...
            <p class="footer-tagline"><?= htmlspecialchars(t('hero_tagline')) ?></p>
        </div>
        <div class="footer-links">
            <h3><?= htmlspecialchars(t('footer_nav_title')) ?></h3>
            <ul>
                <li><a href="#hero"><?= htmlspecialchars(t('nav_home')) ?></a></li>
                <li><a href="#evenements"><?= htmlspecialchars(t('nav_events')) ?></a></li>
                <li><a href="#prochain-evenement"><?= htmlspecialchars(t('nav_next_event')) ?></a></li>
                <li><a href="#a-propos"><?= htmlspecialchars(t('nav_about')) ?></a></li>
                <li><a href="#contact"><?= htmlspecialchars(t('nav_contact')) ?></a></li>
            </ul>
        </div>
        <div class="footer-social">
            <h3><?= htmlspecialchars(t('footer_social_title')) ?></h3>
        ...
        <div class="footer-payment">
            <h3><?= htmlspecialchars(t('footer_payment_title')) ?></h3>
            <a href="<?= htmlspecialchars(REVOLUT_PAYMENT_LINK) ?>" target="_blank" rel="noopener" class="btn btn-gold btn-sm">
                <?= htmlspecialchars(t('footer_pay_btn')) ?>
            </a>
        </div>
    </div>
    <div class="footer-bottom">
        <p>&copy; <?= date('Y') ?> <strong>Palette Ébène</strong>. <?= htmlspecialchars(t('footer_rights')) ?>
        | <a href="mailto:<?= CONTACT_EMAIL ?>"><?= htmlspecialchars(CONTACT_EMAIL) ?></a></p>
    </div>
</footer>
